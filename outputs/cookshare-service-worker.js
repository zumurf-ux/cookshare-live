const CACHE_NAME = "cookshare-live-v29";
...
const APP_FILES = [
  ...
  appUrl("cookshare-recipe-reference.css?v=23"),
  appUrl("cookshare-auth-config.js?v=1"),
  appUrl("cookshare-user-app-live.js?v=13"),
  ...
  appUrl("assets/challenge-tofu-pexels-5848480.jpg")
];
